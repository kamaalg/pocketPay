module github.com/kamaalg/pocketPay/user_service.git
...
replace github.com/kamaalg/pocketPay/db v0.0.0 => ../db

replace github.com/kamaalg/pocketPay/ledger_service => ../ledger_service

replace github.com/kamaalg/pocketPay/observability => ../observability
...
require (
	...
	github.com/kamaalg/pocketPay/observability v0.0.0 // indirect
