...
const (
	Ledger_PostTransaction_FullMethodName = "/ledgerpb.Ledger/PostTransaction"
)
...
type LedgerClient interface {
	PostTransaction(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *ledgerClient) PostTransaction(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*Ack, error) {
...
type LedgerServer interface {
	PostTransaction(context.Context, *Transaction) (*Ack, error)
...
func (UnimplementedLedgerServer) PostTransaction(context.Context, *Transaction) (*Ack, error) {
...
func _Ledger_PostTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LedgerServer).PostTransaction(ctx, req.(*Transaction))
	}
